...
public class MirrorAdapter {
    ...
    private int signUpdateCenterJSON() throws IOException, GeneralSecurityException, CmdLineException {
        ...
        try(InputStream input = new FileInputStream(officialJSON);
            ...
            coreUrl = coreUrl.replaceAll("https://updates.jenkins-zh.cn/download/", mirrorURL);
            ...
            while(it.hasNext()) {
                ...
                url = url.replaceAll("https://updates.jenkins-zh.cn/download/", "https://updates.jenkins-zh.cn/jenkins/");
